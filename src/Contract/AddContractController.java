...
public class AddContractController implements Initializable {
    ...
    @FXML
    private DatePicker dpInputInfo;
    @FXML
    private DatePicker dpOutputInfo;
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        ...
        convert.SetFormatterForDatePicker(dpInputInfo);
        convert.SetFormatterForDatePicker(dpOutputInfo);
